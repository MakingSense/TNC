...
(function e(t, n, r) {
    ...
    1: [
        ...
        function(require, module, exports) {
            ...
            "./src/directions": 7,
            "./src/errors_control": 8,
            "./src/format": 9,
            "./src/input_control": 10,
            "./src/instructions_control": 11,
            "./src/layer": 12,
            "./src/routes_control": 14
        }
    ],
    2: [
            ...
            var Directions = L.Class.extend({
                ...
                queryURL: function() {
                    ...
                    if (L.mapbox.feedback) {
                        L.mapbox.feedback.record({
                            directions: profile + ';' + points
                        });
                    }
                    ...
                    q.await(L.bind(function(err) {
                        ...
                        this._query = request(this.queryURL(), L.bind(function(err, resp) {
                            ...
                            this.directions.routes.forEach(function(route) {
                                route.geometry = {
                                    type: "LineString",
                                    coordinates: polyline.decode(route.geometry, 6).map(function(c) {
                                        return c.reverse();
                                    })
                                };
                            });
        ...
        function(require, module, exports) {
            ...
            module.exports = function(container, directions) {
                ...
                profiles.append('input')
                    ...
                    .attr('name', 'profile')
                    .attr('id', function(d) {
                        return 'mapbox-directions-profile-' + d[1];
                    })
